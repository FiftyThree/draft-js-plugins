...
var LineCounter = function (_Component) {
  _inherits(LineCounter, _Component);

  function LineCounter() {
    _classCallCheck(this, LineCounter);

    return _possibleConstructorReturn(this, (LineCounter.__proto__ || Object.getPrototypeOf(LineCounter)).apply(this, arguments));
  }

  _createClass(LineCounter, [{
    key: 'getLineCount',
    value: function getLineCount(editorState) {
    ...
    value: function render() {
      ...
      var count = this.getLineCount(store.getEditorState());
